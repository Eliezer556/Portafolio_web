  ...
  const projects = [
    {
      ...
      tags: ["DRF", "React", "PostgreSQL"],
      icon: <IconCart size={24} />,
      isFeatured: true,
    },
    {
      title: "Dashboard Analítico",
      desc: "Interfaz reactiva para visualización de métricas en tiempo real, consumiendo APIs externas con Axios.",
      tags: ["React", "Tailwind", "Chart.js"],
      icon: <Zap size={24} />,
      isFeatured: false,
    },
    {
      title: "Scripting Automático",
      desc: "Suite de scripts en Bash para automatizar despliegues y backups de bases de datos MySQL en servidores Linux.",
